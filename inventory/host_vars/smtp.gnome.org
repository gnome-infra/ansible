...
dovecot_ldap_user_filter: (&(objectclass=person)(uid=%n)(mail=%n@staff-mail.gnome.org))
dovecot_mail_privileged_group: staffmail
dovecot_ssl: true
dovecot_ssl_cert_path: /etc/pki/tls/certs/dovecot.pem
dovecot_ssl_key_path: /etc/pki/tls/private/dovecot.pem
