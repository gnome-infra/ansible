...
dovecot_ldap_user_filter: (&(objectclass=person)(|(memberOf=cn=staffmail,cn=groups,cn=accounts,dc=gnome,dc=org)(memberOf=cn=foundation,cn=groups,cn=accounts,dc=gnome,dc=org)(memberOf=cn=emeritus,cn=groups,cn=accounts,dc=gnome,dc=org)(memberOf=cn=mailgrace,cn=groups,cn=accounts,dc=gnome,dc=org)(uid=%n)))
